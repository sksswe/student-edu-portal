...
// import GroupChat from './pages/GroupChat/GroupChat'; // ✅ Keep GroupChat
// import StudyGroupChat from './pages/StudyGroupChat/StudyGroupChat'; // ✅ Add StudyGroupChat
...
//         />
//         <Route
//           path="/group-chat/:id" // For StudyGroupChat, e.g., when clicking "View"
//           element={
//             <ProtectedRoute role="user">
//               <StudyGroupChat />
//             </ProtectedRoute>
  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/study-group-chat/:id" // ✅ Corrected route for StudyGroupChat
          element={
            <ProtectedRoute role="user">
              <StudyGroupChat />
            </ProtectedRoute>
