...
function SignIn() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // Save authentication data with Bearer token and refresh_token
      localStorage.setItem('token', data.access);  // Access token for authentication
      localStorage.setItem('refresh_token', data.refresh);  // Refresh token
      localStorage.setItem('username', username);
      localStorage.setItem('isAuthenticated', 'true');
      localStorage.setItem('role', 'user');  // Assuming user role is 'user' for this example
